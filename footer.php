    ...
    <footer class="footer footer2">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-3">
                    <div class="footer-logo hidden-xs"><a href="index.html"><img src="logo/1.png" style="height: 50px;" alt=""></a></div>
                    <p>© 2018 <span>Empress IAS Academy</span>. All rights reserved</p>
